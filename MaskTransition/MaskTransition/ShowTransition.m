...
@interface ShowTransition()<CAAnimationDelegate>
...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext{
    ...
    CGRect touchRect = [fromVC touchRect];
    ...
    NSLog(@"fromVC = %@ toVC = %@ containerView = %@ ",fromVC,toVC,transitionContext.containerView.subviews);
